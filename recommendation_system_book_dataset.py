# -*- coding: utf-8 -*-
"""Recommendation System - Book Dataset.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1938fzmnRvvSNwXjWjtraxqnvtNsOpGa2
...
"""Berdasarkan output di atas, terdapat 105.283 pengguna yang memberikan rating buku. Jumlah buku yang mendapatkan rating berdasarkan ISBN adalah 340.556 buku. Rating yang diberikan bervariasi antara 0 hingga 10, di mana 0 adalah rating terendah dan 10 adalah rating tertinggi.

Karena dataset ratings memiliki 1.149.780 baris data, jumlah ini cukup besar dan memerlukan alokasi memori yang besar untuk pelatihan model. Untuk menghemat memori, hanya sebagian dari dataset yang akan digunakan. Dataset akan dibatasi pada 50.000 data pertama (tanpa menyertakan baris ke-50000) untuk pengembangan model dengan metode collaborative filtering, karena metode ini membutuhkan data rating pengguna untuk merekomendasikan judul buku kepada pengguna lain. Agar lebih mudah diidentifikasi dan tidak tertukar dengan fitur serupa, variabel ini akan diganti namanya menjadi df_rating.
"""

df_rating = ratings[:50000]
df_rating
...
book_title_test = "Dialogues with Silence: Prayers and Drawings" # contoh judul buku

content_based_filter[content_based_filter.book_title.eq(book_title_test)]

"""Perhatikan, bahwa judul buku 'Dialogues with Silence: Prayers and Drawings' ditulis oleh 'Moira Jones'. Sekarang, gunakan fungsi book_recommendation untuk mendapatkan rekomendasi berdasarkan judul buku tersebut."""
